...
const SubmissionLimitInfo: React.FC<SubmissionLimitInfoProps> = ({
  ...
  // Format chart data for RadialBarChart - only one bar with HubSpot orange color
  const chartData = [
    {
      name: 'Submissions',
      value: percentage,
      fill: '#ff7a59' // HubSpot orange
    }
  ];
  
  return (
    <Card className="card-hubspot h-full flex flex-col">
      ...
      <div className="p-3 pt-0 text-center">
        <div className="text-xl font-bold text-hubspot-orange mb-1">
          {used.toLocaleString()} / {total.toLocaleString()}
        </div>
        <div className="flex justify-center gap-4 mb-2">
          <p className="text-hubspot-gray-600 text-sm">
        ...
        {percentage >= 80 && (
          <div className="bg-hubspot-orange-light border-l-2 border-hubspot-orange p-2 rounded-hubspot mb-2">
            <p className="text-hubspot-gray-800 text-xs">
              {percentage >= 90 
        ...
        <button className="btn-hubspot text-xs py-1 px-4 mb-0">
          Upgrade Plan
        </button>
      </div>
    </Card>
