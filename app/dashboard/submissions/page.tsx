  ...
  if (isLoading) {
    return (
      <div className="card-parrot text-center p-8">
        <p className="text-parrot-gray-600">Loading submissions...</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      {submissions.length === 0 ? (
        <div className="card-parrot text-center p-8">
          ...
          <h2 className="text-xl font-semibold text-parrot-blue-dark mb-2">No submissions yet</h2>
                ...
                {submissions.map((submission) => (
                  <tr key={submission.id} className="hover:bg-parrot-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-parrot-blue-dark">
                        {submission.form?.name || 'Unknown Form'}
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm text-parrot-gray-900 max-w-md overflow-hidden">
          ...
          {pagination && pagination.pages > 1 && (
            <div className="bg-white px-4 py-3 flex items-center justify-between border-t border-parrot-gray-200 sm:px-6">
              ...
              <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                  <p className="text-sm text-parrot-gray-700">
