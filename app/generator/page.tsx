...
export default function GeneratorPage() {
  ...
  return (
    <div className="min-h-screen bg-buddha-gray-50 pb-20">
      ...
      {/* Page title section */}
      <div className="bg-gradient-to-r from-buddha-blue to-buddha-blue-dark text-white py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <h1 className="text-4xl font-bold mb-4 text-white">Free HTML Form Generator</h1>
          <p className="text-xl text-buddha-blue-light max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {formTemplates.map((template) => (
            <Link 
              ...
              className="bg-white rounded-buddha shadow-buddha hover:shadow-buddha-md transition-shadow duration-200 cursor-pointer overflow-hidden border border-buddha-gray-200"
            >
              <div className="p-6">
                <div className="flex items-center mb-4">
                  <div className="text-3xl mr-3">{template.icon}</div>
                  <h3 className="text-lg font-medium text-buddha-blue-dark">{template.title}</h3>
                </div>
                <p className="text-buddha-gray-600 text-sm">{template.description}</p>
                <div className="mt-4 text-buddha-orange hover:text-buddha-orange-dark font-medium text-sm flex items-center">
                  Use this template
      ...
      <div className="container mx-auto max-w-6xl px-4 mt-16">
        <div className="bg-white rounded-buddha-lg shadow-buddha p-8 border border-buddha-gray-200">
          <h2 className="text-2xl font-semibold text-buddha-blue-dark mb-6">Why use BuddhaForms Generator?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="bg-buddha-orange text-white p-3 rounded-buddha inline-block mb-4">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-xl font-medium text-buddha-blue-dark mb-2">Quick & Easy</h3>
              <p className="text-buddha-gray-600">
            ...
            <div>
              ...
              <h3 className="text-xl font-medium text-buddha-blue-dark mb-2">100% Free</h3>
              <p className="text-buddha-gray-600">
            ...
            <div>
              ...
              <h3 className="text-xl font-medium text-buddha-blue-dark mb-2">Customizable</h3>
              <p className="text-buddha-gray-600">
      ...
      <div className="container mx-auto max-w-6xl px-4 mt-16 text-center">
        <h2 className="text-2xl font-semibold text-buddha-blue-dark mb-4">Ready to create your own form?</h2>
        <p className="text-buddha-gray-600 max-w-2xl mx-auto mb-8">
          Choose a template above to get started or sign up for a free account to save your forms and collect submissions.
        </p>
        <Link href="/dashboard" className="btn-buddha text-base px-8 py-3">
